...
5. Frame ancestry, cell order, key bindings, operation attempts, calls, answers, closures, and the sole terminal must form one valid event history. Conflicting duplicate identities fail as corruption.
